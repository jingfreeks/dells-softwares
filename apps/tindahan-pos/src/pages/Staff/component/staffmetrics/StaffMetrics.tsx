...
import type { StaffAccountCounts, VoidsThisWeek } from "../../lib";
import { MOCK_ON_SHIFT_NAME, MOCK_ON_SHIFT_SINCE, MOCK_DRAWER_VARIANCE, MOCK_DRAWER_VARIANCE_SHIFT_COUNT } from "./mockShiftMetrics";
...
export function StaffMetrics({ counts, voids, onStaffAccountsClick, onVoidsClick }: StaffMetricsProps) {
  return (
    <div className="tpl-g4" style={{ marginTop: 18, marginBottom: 14 }}>
      ...
      <button type="button" onClick={onStaffAccountsClick} className="tpl-metric" style={{ textAlign: "left", cursor: "pointer", width: "100%", font: "inherit", color: "inherit" }}>
      ...
      <button type="button" onClick={onVoidsClick} className="tpl-metric" style={{ textAlign: "left", cursor: "pointer", width: "100%", font: "inherit", color: "inherit" }}>
