...
import { useStoreData, buildDailyReport, salesByCategory, stockStatus, STORE_NAME, PESO } from "@/lib";
import type { CardSection } from "@/lib/reportPdf";
import { StatCard, Topbar, SectionCardHeader, type CardActions, DocumentReportIcon, DownloadIcon, PrintIcon, ShareIcon } from "@/components";
