...
import { useAuth, useStoreData, supabase, uploadImage, validateAndOptimizeImage, PESO, selectOnFocus, useFeatureFlag, type Product } from "@/lib";
import {
  buildBarcodeIndex,
...
import { StockBadge, CameraIcon, ImagePlaceholderIcon, TruckIcon, ScannerLoadingOverlay, CategoryManager } from "@/components";
